...
source *stakes*, not what it mentions. 5-15 per source. Every line comes from a
passage read at that line number in this session, never from memory of the field;
where a line states a direction, a hypothesis or a quantifier, re-read the sentence
before writing it. When a later search verifies a quote that contradicts a line here,
the quote wins: fix the line.
